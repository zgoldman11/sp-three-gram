...
declare type Resolver = (error: null | string | DatabaseError) => void;
...
export declare class ResultIterator<T> extends Promise<Result<T>> {
    ...
    notify(done: boolean, status?: (string | DatabaseError)): void;
    [Symbol.asyncIterator](): AsyncIterator<ResultRow<T>>;
}
export declare type DataHandler<T> = Callback<T | null | string | DatabaseError>;
export declare type NameHandler = Callback<string[]>;
export declare function makeResult<T>(): {
    iterator: ResultIterator<T>;
    dataHandler: Callback<string | DatabaseError | T[] | null>;
